...
/*
  NOTE: (Nov 2025, Clint)
  This version of BM_Detector.cc contains several older, commented out parts of the geometry
  from earlier versions.  If you are having trouble with the regular BM_Detector.cc, 
  you may be able to pull what you need from this file.
*/
